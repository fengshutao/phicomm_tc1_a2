...
#if (EXAMPLE_USE_DEMO==USER_SNIFFER_DEMO)
...
void app_init(void)
{
	...
	u_printf("start 802.11 packet send ...\r\n");
	hfwifi_scan_ex(NULL, NULL, 0, 1);//must use hfwifi_scan to init wifi driver
	msleep(100);//little sleep, not necessary
