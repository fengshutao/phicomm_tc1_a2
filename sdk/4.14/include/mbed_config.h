...
#define MBED_CONF_LWIP_UDP_SOCKET_MAX         8      // set by library:lwip
...
#define MBED_CONF_LWIP_TCP_SOCKET_MAX         12     // set by library:lwip
#define MBED_CONF_RTOS_PRESENT                1      // set by library:rtos
#define MBED_CONF_CORE_STDIO_CONVERT_NEWLINES 1      // set by library:core[UNO_91H]
#define MBED_CONF_LWIP_SOCKET_MAX             12     // set by library:lwip
